...
* to import your data:
    ...
    + instead, **ALWAYS** use a relative file path, typically `read.csv("data-in/mydata")` if the name of the data file you added was "mydata"---but always leaving the `data-in/` prefix in the paths
...
data <- read.csv("data-in/mydat.csv")
